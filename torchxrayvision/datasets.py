...
class MIMIC_Dataset(Dataset):
    ...
    def __init__(self,
        ...
        # test_df = self.split_dataset[(self.split_dataset['label'] == 'GT') & (self.split_dataset['test_output'] == '1_2')]
        test_df = self.split_dataset[(self.split_dataset['split'] == 'test')]
        ...
        # print('preeeeeeee__finallllll',final_df)

        self.csv = self.csv.set_index(['subject_id', 'study_id'])
        final_df = final_df.set_index(['subject_id', 'study_id'])
        # print(final_df)

        # self.csv = self.csv.join(final_df).reset_index()
